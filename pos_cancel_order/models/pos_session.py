...
class PosSession(models.Model):
    ...
    # override only to set filter for not cancelled orders
    def _accumulate_amounts(self, data):
        ...
        for order in self.order_ids.filtered(lambda order: order.state != 'cancel'):
    ...
    # override only to filter not cancelled orders
    def _create_picking_at_end_of_session(self):
        ...
        for order in self.order_ids.filtered(lambda o: o.state !='cancel'):
